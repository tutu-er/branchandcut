#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run the case30lite surrogate-model test preset.

Examples
--------
    python run_test_case30lite.py
...
# MODEL_DIR = "result/surrogate_models/subproblem_models_case30lite_20260509_215837"
...
def _run_activity_check(args: argparse.Namespace) -> None:
    output_dir = (
        ...
        if args.activity_output_dir
            ...
            / "result"
            / "figures"
            / "case30lite_global_surrogate_solve_stats"
            / "activity"
        )
    )
    argv = [
