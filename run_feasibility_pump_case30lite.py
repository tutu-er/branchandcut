#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run the lightweight case30-specialized feasibility-pump evaluation preset."""
...
def main() -> None:
    ...
    rt.FP_CONF_THRESHOLD = 0.16
    rt.FP_MAX_ITER = 60
    rt.FP_MAX_PERTURBATION_HOT_STARTS = 7
    rt.FP_MAX_UNIT_OPTIONS_PER_GENERATOR = 5
    rt.FP_MAX_UNIT_COMBINATION_CANDIDATES = 16
    rt.FP_MAX_NEARBY_COMMITMENT_HOT_STARTS = 5
    rt.FP_NEARBY_COMMITMENT_POOL_SIZE = 14
    rt.FP_PARALLEL_STARTS = 2
    rt.FP_SURROGATE_SCREEN_MODE = "robust"
    rt.FP_SURROGATE_SCREEN_MAX_CONSTRAINTS_PER_UNIT = 4
    rt.FP_SURROGATE_SCREEN_MIN_SUPPORT_RATIO = 0.82
    rt.FP_SURROGATE_SCREEN_MAX_NORMALIZED_VIOLATION = 0.06
    rt.FP_SURROGATE_SCREEN_MIN_MEAN_MARGIN = 0.015
    rt.FP_PROJECTION_OBJECTIVE_TAU = "adaptive"

    print("=" * 72, flush=True)
    print(
        f"case30lite FP | mode={rt.MODE} | samples={rt.TEST_SAMPLES} | "
