#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build active-set samples for perturbed case30lite."""
...
from src.case_registry import CASE30LITE_LOAD_SCALE, build_case30lite_perturbed_base_load
...
def main() -> None:
    args = _parse_args()
    ppc, base_load = build_case30lite_perturbed_base_load(args.horizon, scale=args.load_scale)
