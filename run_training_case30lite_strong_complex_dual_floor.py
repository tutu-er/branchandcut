#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Train case30lite with stronger dual floors for complex surrogate constraints."""
...
import run_training_case30lite as base
...
def main() -> None:
    ...
    print("=" * 72, flush=True)
    print(
        f"case30lite strong-complex-dual-floor training | target={rt.MODE} | "
