...
# Keep the single-time surrogate dual cap gentle: cap remains at the sign4
# floor level while the penalty only discourages extreme tails.
SINGLE_MU_CAP_WEIGHT = 0.50
SINGLE_MU_CAP_INITIAL_WEIGHT = 0.00
SINGLE_MU_CAP_INITIAL = SIGN4_DUAL_FLOOR
SINGLE_MU_CAP_FINAL = 5.00
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--unit-workers", type=int, default=base.N_WORKERS_UNIT)
